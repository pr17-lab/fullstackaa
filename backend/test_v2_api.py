...
def main():
    print("Starting FastAPI server on port 8015...")
    ...
    try:
        # 1. Login
        print("\n--- 1. Login ---")
        res = requests.post(f"{API_URL}/api/auth/login", data={"username": "S00001", "password": "S00001@123"})
        ...
        # Need to fetch the roadmap to get a task ID
